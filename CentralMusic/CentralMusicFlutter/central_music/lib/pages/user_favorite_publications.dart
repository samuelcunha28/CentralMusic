...
import 'package:central_music/widgets/favorite_publication_details.dart';

import '../helpers/storage_helper.dart';
import 'image_slider.dart';

class UserFavoritePublications extends StatefulWidget {
  const UserFavoritePublications({Key key}) : super(key: key);

  @override
  _UserFavoritePublications createState() => _UserFavoritePublications();
}

class _UserFavoritePublications extends State<UserFavoritePublications> {
  int range;
  ...
  void initState() {
    ...
    if (loading == true) {
      Services.getFavoritePublicationsById().then((publicationss) {
        setState(() {
          publications = publicationss;
          publications = publications.reversed.toList();
          loading = false;
    ...
    return Scaffold(
        body: Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(
              loading ? 'Loading...' : 'Publicações favoritas\nCarregue para mais informações',
              style: TextStyle(
                  fontSize: 18,
              ...
              child: GridView.count(
                ...
                children: publications == null
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => PublicationDetailsPage(context: context,  gridItem: data)));
                    },
                    child: Padding(
