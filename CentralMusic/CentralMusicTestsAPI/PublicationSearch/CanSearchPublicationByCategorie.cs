...
{
    public class CanSearchPublicationByCategorie
    {

        private Connection _connection;
        private PublicationFixture _fixture;

        public CanSearchPublicationByCategorie()
        {
        ...
        [Fact]
        public void CanSearchPublicationByCategorie_UserId()
        {
            ...
            Categories[] categories = { Categories.Cordas };
            searchResult = pDAO.GetPublications(null, categories, null, null);
