...
namespace CentralMusicTestsAPI.LoginTests
{
    ...
    public class CanUserLoginWithCorrectPassword
    {
        private Connection _connection;
        private LoginTestsFixture _fixture;

        public CanUserLoginWithCorrectPassword()
        {
        ...
        public void CanUserLoginTest()
        {
            ...
            Assert.True(PasswordEncrypt.VerifyHash("samuelcunha", returnedUser.Password, returnedUser.PasswordSalt));
            _fixture.Dispose();
        }
        */
    }
